    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 px-6 sm:my-16 md:my-16">
        ...
        <div className="md:w-1/2 text-left">
          ...
          <p className="mt-4 sm:text-lg md:text-lg text-sm text-black">
          ...
          <Link
            href="/AboutGUBCPA"
            className="hover:text-indigo-400 text-indigo-500 mt-6 inline-flex items-center font-semibold hover:underline"
          >
        ...
        <div className="md:w-1/2 relative flex flex-col items-center border-2 border-white rounded-2xl p-3 sm:p-12 shadow-xl">
          ...
          {/* Info Box */}
          <div className="w-72 bg-indigo-600 rounded-2xl shadow-2xl p-6 sm:absolute bottom-0 md:-bottom-10 right-0 sm:right-6 border border-gray-300 transform md:translate-x-14 md:translate-y-32">
